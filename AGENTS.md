...
- When continuing a multi-session task, read the release plan at `.Codex/plans/release-1.0.md` and the last CHANGELOG entry to orient before acting.
...
- Branch naming: `Codex/epic-<n>-<slug>`.

## Skills

Invoke with `/skill-name`. Details in `.Codex/skills/<name>/SKILL.md`.
...
- `.Codex/agent/01-project-profile.md` — scope, platform, dependency policy
- `.Codex/agent/02-engineering-standards.md` — API design, file structure, concurrency
- `.Codex/agent/03-validation-and-quality-gates.md` — coverage targets, test isolation
- `.Codex/agent/04-workflow-reporting-and-commits.md` — workflow, branching, reporting
- `.Codex/agent/05-skills-and-context-organization.md` — skill authoring rules
